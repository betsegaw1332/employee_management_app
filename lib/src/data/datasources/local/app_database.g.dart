    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `employees` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `employeeName` TEXT, `employeeRole` TEXT, `startingDate` TEXT, `endDate` TEXT)');
...
class _$EmployeeDao extends EmployeeDao {
  ...
  Future<List<EmployeeModel>> getAllEmployees() async {
    return _queryAdapter.queryList('SELECT * FROM employees',
        mapper: (Map<String, Object?> row) => EmployeeModel(
            ...
            startingDate: row['startingDate'] as String?,
  ...
  Future<void> deleteEmployee(EmployeeModel employee) async {
    await _employeeModelDeletionAdapter.delete(employee);
  }
}
